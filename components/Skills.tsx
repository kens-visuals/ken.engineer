  ...
  return (
    <Section id="skills">
      ...
      <div className="my-10 grid grid-cols-2 grid-rows-mobile-row-layout gap-4 text-3xl font-bold md:grid-cols-4 md:grid-rows-tablet-row-layout lg:grid-flow-row-dense lg:grid-cols-6 lg:grid-rows-desk-row-layout">
        <div className="relative col-span-2 flex items-start rounded-lg bg-resume-pattern p-4 md:row-span-2 lg:col-start-1 lg:col-end-3 lg:row-start-1 ">
        ...
        <div className="relative col-span-2 row-span-2 flex items-start rounded-lg bg-main-tools-pattern p-4 lg:col-start-5 lg:col-end-7 lg:row-start-1 lg:row-end-3">
